# SEBS Estimation of Evapotranspiration Fraction

`sebs` computes Su (2002) Surface Energy Balance System (SEBS) for
...
pressure deficit). For information on data input procedure see 'details'
at [`sebal`](https://gowusu.github.io/sebkc/reference/sebal.md)

## References

Su, Z. 2002. The Surface Energy Balance System (SEBS) for estimation of
turbulent heat fluxes. Hydrol. Earth Syst. Sci., 6(1): 85-100.
